<script>
	...
	let videos = [
		...
		},
		{
			...
			tag: 'Video',
			caption:
				"A cooking video, inspired by <a class='font-semibold text-blue-500 underline hover:font-bold hover:text-blue-600' href='https://www.youtube.com/watch?v=86QgYvlWEU0' target='_blank'>Alvin's cooking videos</a> from Tasty",
			id: 'DvqI1LAlARY',
	...
	>
		...
		>
			...
			<div class="flex flex-col px-2 mx-2 md:ml-4 md:pr-8">
				...
				<p
					class="relative px-2 py-1 mx-2 text-xs font-semibold transition duration-300 -translate-x-1 -translate-y-1 border-2 rounded-full border-violet-200 bg-violet-300 w-max group-hover:drop-shadow-sm filter"
				>
					{tag}
				</p>
			</div>
