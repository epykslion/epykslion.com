...
<section
  ...
  <!--What I do-->
    <section class="py-4 mx-6 lg:mx-0">
     <div class="container relative flex flex-col max-w-6xl px-6 py-12 mx-auto overflow-hidden filter drop-shadow max-w-screen bg-gradient-to-bl from-slate-800 to-sky-800 rounded-3xl md:flex-row">
...
<section class="py-2 mx-4 mt-12">
  <div class="container relative flex flex-col max-w-6xl px-6 py-12 mx-auto overflow-hidden shadow-sm max-w-screen bg-gradient-to-br from-sky-800 to-slate-800 rounded-3xl">
			<img
    ...
    <div class="flex flex-col text-left filter drop-shadow-sm lg:ml-auto lg:mb-4 md:pl-4 lg:pl-40 md:w-8/12 md:items-start md:mb-0">
      ...
      Code or No-Code, create stunning user experiences, loaded with all that SEO-goodness.
       ...
       <div class="flex mt-12">
        <a href="/services" type="button" class="inline-flex items-center px-6 py-3 my-2 text-lg font-medium text-center transition duration-300 ease-in-out transform border border-transparent rounded-lg text-gray-50 bg-emerald-600 lg:px-12 hover:bg-emerald-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-slate-800">
          Find out how
          <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 ml-3 -mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M17 8l4 4m0 0l-4 4m4-4H3"></path>
          </svg>
    ...
    <ul class="z-20 grid justify-start max-w-xl grid-cols-5 gap-6 mt-4 filter drop-shadow lg:mt-12 ">
