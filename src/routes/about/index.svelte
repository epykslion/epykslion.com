<script>
	import BasicCard from '$lib/shared/ui/components/basiccard/BasicCard.svelte';
</script>
...
<div class="relative max-w-screen-xl p-4 px-4 mx-auto bg-stone-100 sm:px-6 lg:px-8 py-26 lg:mt-20">
	<div class="relative">
		<!--Grid here-->
		<div class="lg:grid lg:grid-flow-row-dense lg:grid-cols-2 lg:gap-8 lg:items-center">
			<div class="ml-auto lg:col-start-2 lg:max-w-2xl">
				<p class="text-base font-normal leading-8 tracking-widest text-gray-400 uppercase">
					Content creator since 2010
				</p>
				<h1 class="mt-2 text-2xl font-extrabold leading-8 text-gray-900 sm:text-3xl sm:leading-9">
					Blending creativity with strategy to deliver truly memorable experiences
				</h1>
				<p class="mt-4 text-xl leading-6 text-gray-500">
					I'm a content creator, filmmaker, and developer who uses a mix of technology and inbound
					strategy to get the job done.<br /><br />
					Most of my time is spent learning, creating something new, or helping other people solve their
					problems.
				</p>
				<br />
				...
				<ul class="gap-6 mt-8 md:grid md:grid-cols-2">
					<li class="mt-6 lg:mt-0">
						<div class="flex">
							<span
								class="flex items-center justify-center flex-shrink-0 w-6 h-6 text-green-800 bg-green-100 rounded-full drark:bg-transparent"
							>
							...
							<span class="ml-4 text-base font-medium leading-6 text-gray-800">
								Video Production
							</span>
						</div>
					</li>
					<li class="mt-6 lg:mt-0">
						<div class="flex">
							...
							<span class="ml-4 text-base font-medium leading-6 text-gray-800"> Photography </span>
						</div>
					</li>
					<li class="mt-6 lg:mt-0">
						<div class="flex">
		...
		<div class="flex flex-wrap justify-center lg:justify-between">
			...
			<BasicCard>
				<img
					...
					alt="Descript's Logo"
					class="mx-2 my-auto transition duration-200 -translate-y-1 grayscale brightness-0 group-hover:drop-shadow-lg group-hover:brightness-100 group-hover:grayscale-0 filter w-11 h-11"
					height="24"
					width="24"
				/>
